    ...
    <div className='bg-gradient-to-t from-yellow-100 md:pb-1'>
      ...
      <section className='md:flex justify-center items-center'>
        ...
        <div className='mx-7 md:mx-0 w-2/3'>
          ...
          <li className='text-sm font-bold'>C.R.I.'s energy efficient product are well recognized by various Government Institutions. as trustworthy products for various projects across the globe to save energy.</li>
